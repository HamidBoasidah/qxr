            ...
            <div>
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  ...
                  <div>
                    ...
                    <div
                      v-if="success"
                      class="mt-3 rounded-md bg-green-50 p-3 text-sm text-green-700 border border-green-100"
                    >
                      {{ success }}
                    </div>
                  </div>
              ...
              <div class="mt-5">
                ...
                >
                  ...
                  <a href="/company/login" class="text-brand-500 hover:text-brand-600 dark:text-brand-400"
                    >Click here</a
                  >
                </p>
              </div>
