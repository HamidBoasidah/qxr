            ...
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        {{ $t('common.edit') }} {{ $t('landing.section') }}
                    </h2>
                    <Link
...
const form = useForm({
    ...
    title: {
        ar: props.section.title?.ar || '',
        en: props.section.title?.en || ''
    },
    subtitle: {
        ar: props.section.subtitle?.ar || '',
        en: props.section.subtitle?.en || ''
    },
    is_active: props.section.is_active,
    settings: props.section.settings || {}
});

const settingsJson = ref(JSON.stringify(props.section.settings || {}, null, 2));
...
const submit = () => {
    ...
    form.put(route('admin.landing.sections.update', [props.landingPage.id, props.section.id]), {
        preserveScroll: true,
        onSuccess: () => {
