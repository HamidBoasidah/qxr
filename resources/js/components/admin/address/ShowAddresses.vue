          ...
          <div class="mt-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <Tooltip :text="t('messages.notAuthorized')" :show="!canEdit">
                <button :disabled="!canEdit" @click="handleEditClick(address.id)" class="text-gray-500 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-300 disabled:text-gray-400 disabled:dark:text-gray-500">
              ...
              <Tooltip :text="t('messages.notAuthorized')" :show="!canDelete">
                <button :disabled="!canDelete" @click="handleDeleteClick(address.id)" class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500 disabled:text-gray-400 disabled:dark:text-gray-500">
...
function toggleAddressStatus(address) {
  ...
  const url = wasActive
    ? route('admin.addresses.deactivate', { id: address.id })
    : route('admin.addresses.activate',   { id: address.id })
  router.patch(url, {}, {
    preserveState: true,
    preserveScroll: true,
