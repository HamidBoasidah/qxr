<template>
  ...
  >
    ...
    <div class="flex-1 max-h-full p-5 space-y-6 overflow-auto custom-scrollbar xl:space-y-8 xl:p-6">
      <div class="max-w-[350px]">
        <div class="flex items-start gap-4">
          <div class="w-full h-10 rounded-full max-w-10">
            <img
              src="/images/user/user-17.jpg"
              alt="profile"
              class="object-cover object-center w-full h-full overflow-hidden rounded-full"
          ...
          <div>
            ...
            <p class="mt-2 text-gray-500 text-theme-xs dark:text-gray-400">Lindsey, 2 hours ago</p>
          </div>
        </div>
      </div>
      ...
      <div class="ml-auto max-w-[350px] text-right">
        ...
        <p class="mt-2 text-gray-500 text-theme-xs dark:text-gray-400">2 hours ago</p>
      </div>
      ...
      <div class="ml-auto max-w-[350px] text-right">
        <div
          class="px-3 py-2 ml-auto rounded-lg rounded-tr-sm max-w-max bg-brand-500 dark:bg-brand-500 dark:text-white/90"
        >
          <p class="text-sm text-white dark:text-white/90">
            If don’t like something, I’ll stay away from it.
          </p>
        ...
        <div
          class="px-3 py-2 mt-2 ml-auto rounded-lg rounded-tr-sm max-w-max bg-brand-500 dark:bg-brand-500"
        >
          <p class="text-sm text-white dark:text-white/90">
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            <div class="mb-2 w-full max-w-[270px] overflow-hidden rounded-lg">
              <img src="/images/chat/chat.jpg" alt="chat" />
            </div>
            <div class="px-3 py-2 bg-gray-100 rounded-lg rounded-tl-sm max-w-max dark:bg-white/5">
    ...
    <div class="sticky bottom-0 p-3 border-t border-gray-200 dark:border-gray-800">
      <form class="flex items-center justify-between">
        <div class="relative w-full">
          <button
            class="absolute text-gray-500 -translate-y-1/2 left-1 top-1/2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90 sm:left-3"
          >
            <svg
              class="fill-current"
              width="24"
        ...
        <div class="flex items-center">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <rect x="7" y="2.75" width="10" height="12.5" rx="5" stroke="" stroke-width="1.5" />
              <path
          ...
          <button
            class="flex items-center justify-center ml-3 text-white rounded-lg h-9 w-9 bg-brand-500 hover:bg-brand-600 xl:ml-5"
          >
            <svg
              width="20"
              height="20"
