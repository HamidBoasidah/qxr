<template>
  <div>
      ...
      <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
          ...
          <div class="order-3 xl:order-2">
            ...
            >
              {{ user?.name || [user?.first_name, user?.last_name].filter(Boolean).join(' ') || t('user.name', { default: 'Code Brains' }) }}
            </h4>

          </div>
          <div class="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
            <a
              :href="user?.facebook || 'https://www.facebook.com/PimjoHQ'"
              target="_blank"
              rel="noopener"
              class="social-button"
            >
            ...
            <a :href="user?.x_url || 'https://x.com/PimjoHQ'" target="_blank" rel="noopener" class="social-button">
              <svg
                class="fill-current"
                width="20"
                height="20"
            ...
            <a
              :href="user?.linkedin || 'https://www.linkedin.com/company/pimjo/'"
              target="_blank"
              rel="noopener"
              class="social-button"
            >
            ...
            <a
              :href="user?.instagram || 'https://www.instagram.com/PimjoHQ'"
              target="_blank"
              rel="noopener"
              class="social-button"
            >
    ...
    <!-- Profile Image Modal -->
    <Modal v-if="isProfileImageModal" @close="isProfileImageModal = false">
      <template #body>
        <div
        ...
        >
          <!-- close btn -->
          <button
            @click="isProfileImageModal = false"
          ...
          <div class="px-2">
            ...
            >
              ...
              <input ref="fileInput" type="file" id="profile-image" class="hidden" accept="image/*" @change="handleFileUpload" />
            </label>
          </div>
...
const isProfileImageModal = ref(false)
