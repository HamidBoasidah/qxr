                        ...
                        <div>
                            <form @submit.prevent="submit">
                                <div class="space-y-5">
                                    ...
                                    <!-- Success -->
                                    <div v-if="success" class="mt-3 rounded-md bg-green-50 p-3 text-sm text-green-700 border border-green-100">
                                        {{ success }}
                                    </div>
...
function submit() {
    form.post(route('admin.password.store'), {
        onSuccess: () => {
            success.value = 'تم تغيير كلمة المرور بنجاح. يمكنك تسجيل الدخول الآن.'
        },
        onError: () => {
            success.value = ''
        },
