    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <div class="p-4 sm:p-6">
        <div class="grid grid-cols-1 gap-x-5 gap-y-6 md:grid-cols-2">
          ...
          <div>
            <label class="mb-1.5 block text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('categories.categoryType') || 'Type' }}</label>
            <p class="text-base text-gray-800 dark:text-white/90">{{ t('categories.types.' + (category.category_type || '')) || category.category_type }}</p>
          </div>
